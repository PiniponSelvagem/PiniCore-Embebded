 ...
 * @param   offset Offset from the start from which byte to start calculating the checksum.
 ...
 */
uint32_t calculateChecksum(const uint8_t* data, size_t size, size_t offset, const uint8_t phrase = 0);
